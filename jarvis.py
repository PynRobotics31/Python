...
while True:
    ...
    if a == "hello" or a == "hi":
        print("Jarvis : Hi there how can i assist your sir")
    ...
    elif(a == "search in youtube "):
    	sy = a[18:]
    	print(f"Jarvis : Searching in youtube {sy}")
    	engine.say(f"searching in youtube {sy}")
    	engine.runAndWait()
    	...
    	engine.say(f"searching in google {sg}")
    	engine.runAndWait()
    else:
